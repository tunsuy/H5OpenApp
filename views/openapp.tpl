...
var list = [{
  ...
  iosPacket:"com.sangfor.easyconnect",
  androidPacket:"com.sangfor.vpn.client.phone",
  ...
  iosDownloadUrl:"itms-services://?action=download-manifest&url=https://dn-moadl.qbox.me/ec.plist",//7.1.9
  androidDownloadUrl:"https://dn-moadl.qbox.me/EasyConnectPhone.apk" //8.0.4.5
